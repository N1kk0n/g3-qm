package g3.qm.queuemanager.init.repositories;

import g3.qm.queuemanager.init.repositories.state.ComponentRepository;
...
public class InitRepository {
    ...
    private void createCacheTables() {
        cacheTemplate.execute("create table if not exists QUEUE_MANAGER_PARAM(ID identity primary key, PARAM_NAME varchar(32) unique, PARAM_VALUE varchar(256))");
        cacheTemplate.execute("insert into QUEUE_MANAGER_PARAM(PARAM_NAME, PARAM_VALUE) values('UPDATE_DECISION_FLAG', 'false')");
